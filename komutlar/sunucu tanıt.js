...
exports.run = async (client, message, args) => {
  ...
  .setTitle('BAŞARILI')
  .addField('Sunucu burada tanıtıldı! (sunuculinkiniz).')
  .addField('12 saat Sonra sunucunuzu Tekrardan Tanıtabilirsiniz.')
  .addField('Sunucunu tanıtabilmek için beni ekle! botdavetlinki')
  .setColor('GREEN')
 message.channel.sendEmbed(embed);
  ...
  message.channel.send({embed: {
      description: '**BAŞARISIZ TANITIM**:sparkles:  \n\nBu komut zaten kullanılmış!\n\nSunucunu 12 saate 1 defa tanıtabilirsin!  \n\n[Destek Sunucusu](desteksunuculink) \n[Beni Sunucuna Ekleyebilmek İçin Tıklaman Yeterli!](botdavetlink) [UltraCoddingTeam Resmi Discord Sunucusu](https://discord.gg/T5ty2yG)'     
        }});
  }
};
